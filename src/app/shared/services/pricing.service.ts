...
export class PricingService {
  ...
  public annualPlans = [
    ...
    {
      id:'annualTeamMembers',
      name: 'Team Members',
      freelancerQuizHead: '1',
      freelancerQuizDescription: '1 user or admin',
      freelancerHead: '1',
      freelancerDescription: '1 user or admin',
      essentialsHead: '3',
      essentialsDescription: '3 users or admins total',
      businessHead: '10',
      businessDescription: '10 users or admins total',
      freelancerQuizClass:'quater',
      freelancerClass:'quater',
      essentialsClass:'half',
      businessClass:'full',
